...
static const char* const TEMP_CUSTOM_ENDPOINT_URL = "http://192.168.0.135:5000";
...
struct CoreContext
{
     ...
     *  resulting URL.
     * @param out_url Mutable reference to the std::string that will contain the final
     *  URL value. Reuses existing string memory; reallocating only when the string does
     *  not yet have the required capacity.
     */
