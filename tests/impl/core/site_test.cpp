...
TEST_CASE("GetIntakeOrigin", "[unit]")
{
    ...
    {
        REQUIRE(
            GetIntakeOrigin(Site::us1, "") == "https://browser-intake-datadoghq.com"
        );
        REQUIRE(
        ...
        REQUIRE(
            GetIntakeOrigin(Site::eu1, "") == "https://browser-intake-datadoghq.eu"
        );
        REQUIRE(
    ...
    {
        REQUIRE(
            GetIntakeOrigin(Site::us1, "http://127.0.0.1:5000") ==
            "http://127.0.0.1:5000"
        );
