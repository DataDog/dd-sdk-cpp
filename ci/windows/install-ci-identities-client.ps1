...
$exeUrl = "https://binaries-ddbuild-io-prod.s3.us-east-1.amazonaws.com/ci-identities/ci-identities-gitlab-job-client/versions/v$($Version)/ci-identities-gitlab-job-client-windows-amd64.exe"
