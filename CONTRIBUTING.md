...
- [`src/impl/`][src-impl] implements the core business logic of the library, split into:
    - [`core/`][impl-core]: Implements the primary business logic of the SDK, including:
        ...
        - [`upload.hpp`][upload-hpp]: Business logic of the upload thread, which periodically reads batches of events from storage, passes them to the appropriate feature implementation for processing, them sends them to intake over HTTP.
