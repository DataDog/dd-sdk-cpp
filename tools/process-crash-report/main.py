...
This tool parses crash reports generated by the SDK's crash handler, resolves
raw memory addresses to module+offset pairs, and symbolicates them using
platform-specific tools (atos, llvm-symbolizer, addr2line, or dbh).
